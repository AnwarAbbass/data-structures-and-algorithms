...
const arr = ['BeAr', 'lIon'];
console.log( updateAnimal(arr, upper));

    const arr1 = ['BeAr', 'lIon'];
   console.log( updateAnimal(arr1, lower));
...
console.log(sortNumbers([8, 3, 2, 9, 12, 1, 115]));
...
console.log(sortBackwards([8, 3, 2, 9, 12, 1, 115]));
console.log(sortBackwards([3,2,1]));
...
console.log(alphabetize(['Zebra', 'alphabet','carrot','Alphabet']));
