...
// console.log(checkValues({ class: '301' }, '401'))
...
// console.log(updateNumbers(startingObj).includes('Grace Hopper: 229-303-5938'));
...
console.log(getHouses(characters).length);
