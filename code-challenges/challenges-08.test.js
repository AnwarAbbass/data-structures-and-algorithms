...
console.log('3',containsAnd(['panda', 'ran', 'and']));
...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  let exp= /\s*(u|o|i|e|a)\s*/;
  return arr.filter(item => exp.test(item));
};
console.log('5',filterStringsWithVowels(['gregor','hound','xyz']));
...
console.log('6',notInFirstArray([1,2,3], [1,2,3,4]));
