...
return arr.reduce((acc,val,idnx)=>{
    // console.log(val,val.length > longest.length)
...
console.log('1',longestString(['Ginger']));
...
const firstLetters = (arr) => {
  // Solution code here...
  return arr.map((val,indx)=> val[0]);
};
console.log('2',firstLetters(['this is great :)', 'wow', 'whyyyyyy :(', ':)))))']));
...
console.log('3',findHappiness(['this is great :)', 'wow', 'whyyyyyy :(', ':)))))']))
