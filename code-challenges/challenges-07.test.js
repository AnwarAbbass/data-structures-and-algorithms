...
console.log(replaceZeros('301 is 0s fun'));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
console.log('4',forLoopTwoToThe([0,4,5]));
...
console.log('5',forEachTwoToThe([0,4,5]))
...
console.log('6',mapTwoToThe([0,4,5]))
